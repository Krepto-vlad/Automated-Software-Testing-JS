...
When('I fill in the form with name {string}, email {string}, current address {string}, and permanent address {string}', 
...
Then('I should see the output with name {string} and email {string}', async function (name, email) {
