...
test.describe('Tooltips scenarios', () => {
  ...
  test('Hover over elements and check tooltips', async ({ page }) => {
    ...
    await test.step('Check tooltip on Field', async () => {
      ...
      const tooltipText = await toolTipsPage.getTooltipText(toolTipsPage.tooltips.field);
    ...
    await test.step('Check tooltip on Button', async () => {
      ...
      const tooltipText = await toolTipsPage.getTooltipText(toolTipsPage.tooltips.button);
    ...
    await test.step('Check tooltip on "Contrary"', async () => {
      ...
      const tooltipText = await toolTipsPage.getTooltipText(toolTipsPage.tooltips.contrary);
    ...
    await test.step('Check tooltip on "Section"', async () => {
      ...
      const tooltipText = await toolTipsPage.getTooltipText(toolTipsPage.tooltips.section);
